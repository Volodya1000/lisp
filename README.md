...
1. [Примеры кода (Тесты и Демонстрация)](#примеры-кода-тесты-и-демонстрация)
...
# Примеры кода (Тесты и Демонстрация)

Ниже приведены фрагменты кода на Lisp, на которых проводилось тестирование и демонстрация возможностей компилятора.
Полный исходный код примеров находится в репозитории: [GitHub: Volodya1000/lisp/examples](https://github.com/Volodya1000/lisp/tree/master/examples).
